      ...
      <AboutMeConatiner>
        <div>
          <div>
            ...
            <p>
              João era um jovem entusiasmado com a ideia de mergulhar no mundo
              da programação. Ele estava cheio de curiosidade e determinação
              para se tornar um programador habilidoso. Apesar de ser um
              iniciante, João estava pronto para enfrentar os desafios e
              aprender tudo o que fosse necessário para atingir seus objetivos.
              No início, João se deparou com uma infinidade de conceitos e
              linguagens de programação, o que o deixou um pouco confuso. Mas
              ele não se deixou abater e começou a se dedicar a estudar os
              fundamentos da programação. Ele passava horas lendo livros,
              assistindo tutoriais online e fazendo cursos introdutórios.
              Gradualmente, João começou a entender os conceitos básicos, como
              variáveis, loops e condicionais. Ele ficava empolgado quando
              conseguia escrever seu primeiro programa simples, mesmo que fosse
              apenas um "Olá, mundo!". A cada pequena vitória, sua confiança
              crescia e ele se sentia mais motivado a explorar novas
              possibilidades. No entanto, João também enfrentou momentos de
              frustração. Ele se deparou com erros de sintaxe, bugs difíceis de
              serem resolvidos e desafios de lógica que pareciam impossíveis de
              serem superados. Mas ele aprendeu que esses obstáculos faziam
              parte do processo de aprendizado e que a persistência era
